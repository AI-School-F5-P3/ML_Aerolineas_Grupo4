...
def train_and_evaluate_model():
    ...
    joblib.dump(scaler, os.path.join(MODELS_DIR, 'scaler_RandomForest1.pkl'))
    joblib.dump(model, os.path.join(MODELS_DIR, 'RandomForest_model1.pkl'))
...
def load_model():
    model = joblib.load(os.path.join(MODELS_DIR, 'RandomForest_model1.pk'))
    scaler = joblib.load(os.path.join(MODELS_DIR, 'scaler_RandomForest1.pkl'))
    return model, scaler
